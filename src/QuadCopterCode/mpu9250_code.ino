...
#define A_DLPF_CFG_460Hz \
    0x00 // Hz is for bandwidth, not rate (the rate is 1kHz)
#define A_DLPF_CFG_184Hz 0x01
#define A_DLPF_CFG_92Hz 0x02
#define A_DLPF_CFG_41Hz 0x03

#define GYRO_FCHOICE \
    0x03 // to enable digital low-pass filter (bit 0 = 1, and bit 1 = 1)
#define GYRO_DLPF_CFG_250HZ \
    0x00 // Hz is for bandwidth, not rate (the rate is 1kHz)
...
// #######################################################################################################
void setup_mpu9250(int accel_range, int gyro_range, int mag_bits, int gyro_dlfp,
                   int accel_dlpf)
{
                 ...
                 int accel_dlpf)
{
    ...
    writeByte(
        ...
        0x5); // Use a 200 Hz rate; a rate higher than the filter update rate
