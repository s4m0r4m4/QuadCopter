...
void setup() {
  ...
  Serial.print("Initial Pitch = "); Serial.println(euler_angles[1]);
  Serial.print("Initial Roll = "); Serial.println(euler_angles[2]);
  ...
  Serial.print("Pitch = "); Serial.println(euler_angles[1]);
