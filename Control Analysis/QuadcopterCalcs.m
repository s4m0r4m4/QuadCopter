...
mass_real = 635.0/1000; % kg
mass_adj = mass_real/(479.82/1000);
Ix = 2868456.42 * (1/1000) * (1/(1000^2)) * mass_adj;
Iy = 2779050.14 * (1/1000) * (1/(1000^2)) * mass_adj;
deltaZ = 35.71/1000; % Offset between propeller plane and center of mass
% Iz = 4263587.01;
